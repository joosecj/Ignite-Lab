...
export type GetLessonByeSlugQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type GetLessonByeSlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', avatarURL: string, bio: string, name: string } | null } | null };
...
export const GetLessonByeSlugDocument = gql`
    query GetLessonByeSlug($slug: String) {
...
/**
 * __useGetLessonByeSlugQuery__
 *
 * To run a query within a React component, call `useGetLessonByeSlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLessonByeSlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLessonByeSlugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGetLessonByeSlugQuery(baseOptions?: Apollo.QueryHookOptions<GetLessonByeSlugQuery, GetLessonByeSlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLessonByeSlugQuery, GetLessonByeSlugQueryVariables>(GetLessonByeSlugDocument, options);
      }
export function useGetLessonByeSlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLessonByeSlugQuery, GetLessonByeSlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLessonByeSlugQuery, GetLessonByeSlugQueryVariables>(GetLessonByeSlugDocument, options);
        }
export type GetLessonByeSlugQueryHookResult = ReturnType<typeof useGetLessonByeSlugQuery>;
export type GetLessonByeSlugLazyQueryHookResult = ReturnType<typeof useGetLessonByeSlugLazyQuery>;
export type GetLessonByeSlugQueryResult = Apollo.QueryResult<GetLessonByeSlugQuery, GetLessonByeSlugQueryVariables>;
